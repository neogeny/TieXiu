...
pub struct ParseStateStack<C: Cursor> {
    pub states: Vec<ParseState<C>>,
    pub ruleinfo_stack: Vec<String>, // Placeholder for RuleInfo
}

impl<C: Cursor> ParseState<C> {
...
//         self.cursor.goto(other.cursor.mark());
...
//         self.top().cursor.goto(popped.cursor.mark());
//         popped
//     }
//
